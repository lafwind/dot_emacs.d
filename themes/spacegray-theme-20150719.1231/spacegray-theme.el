...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Search
   `(match ((,class (:foreground ,background :background ,lafwind_pink :inverse-video nil))))
   `(isearch ((,class (:foreground ,background :background ,lafwind_pink))))
   `(isearch-lazy-highlight-face ((,class (:foreground ,foreground :background ,lafwind_pink :inverse-video nil))))
